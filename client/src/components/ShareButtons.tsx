...
const btnClass =
  'p-2 rounded-full text-neutral-400 hover:text-brand-700 hover:bg-brand-50 transition-colors focus-visible:ring-2 focus-visible:ring-brand-500'
...
export default function ShareButtons({ url, title, description }: ShareButtonsProps) {
  ...
  return (
    <div className="flex items-center gap-1 mt-4">
      <span className="text-xs font-bold uppercase tracking-wider text-neutral-400 mr-1">Share</span>
