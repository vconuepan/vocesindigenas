...
<div class="wrap">
    <h1><?php _e('RelevanceSpider'); ?> - Podcasts</h1>
    ...
    <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
        ...
        <button type="submit"><?php _e('Add Podcast'); ?></button>
    </form>
    </div>
            ...
            <tbody>
                ...
                <?php foreach ($records as $record): ?>
                    ...
                    <tr class="expandable-row <?php echo $row_class; ?>">
                        ...
                        <td></td>
                        <td><a href="admin.php?page=relevancespider-podcasts&subpage=podcast&id=<?php echo $record->id; ?>"><?php echo substr($record->title, 0, 70); ?></a>
                        ...
                        <td>
                            <button type="button" class="icon-button no-expand" title="Fetch posts" onclick="submitIndividualAction('podcast_fetch_posts', <?php echo $record->id; ?>)">
                                <span class="dashicons dashicons-editor-ul"></span>
                            </button>

                            <button type="button" class="icon-button no-expand" title="Generate script" onclick="submitIndividualAction('podcast_generate', <?php echo $record->id; ?>)">
    ...
    <script>
        document.getElementById('filter-form').addEventListener('submit', function(e) {
            ...
            const baseUrl = '<?php echo esc_url(admin_url("admin.php?page=relevancespider-podcasts")); ?>';
        ...
        function navigateToEdit(id) {
            ...
            url.searchParams.append('page', 'relevancespider-podcasts');
            url.searchParams.append('subpage', 'podcast');
